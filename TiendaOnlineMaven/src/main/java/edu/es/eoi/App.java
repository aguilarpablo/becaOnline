...
//		Producto p1 = new Batidora("Moulinex BC1", "4589865412", 40, "Maravillosa batidora", 20, "BC1", 220, 2200);
//		Producto p2 = new Batidora("Aliexpress CC", "4449865412", 20, "Batidora barata", 20, "CC", 220, 2200);
...
//		Producto p5 = new Television("Samsung", "6734598409", 450, "TV 42'", 5, "SS1", 230, "HD4k", "Samsung");	
		...
		pedidoController = new PedidoController(pedidos, carrito);
