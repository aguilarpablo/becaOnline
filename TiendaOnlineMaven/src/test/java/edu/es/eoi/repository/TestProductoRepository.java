...
public class TestProductoRepository {
	...
	public void testGuardar() throws Exception {	
		ProductoRepository repository= new ProductoRepository();	
		repository.create(new Producto("ProductoTEST","123456",100,"descripcion",5));
		repository.create(new Producto("ProductoTEST2","654132",50,"descripcion",5));
		repository.create(new Zapatilla("Nike Air Jordan", "4858789865", 100.0, "Jordan shoes", 10,"nike","42.5"));
